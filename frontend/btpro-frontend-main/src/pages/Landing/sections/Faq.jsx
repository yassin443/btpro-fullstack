...
import { cx, Icon, Container, SectionHeader, Reveal } from '../_ui'
...
function FaqItem({ q, a, open, onToggle, idx }) {
  return (
    <div className="border-b border-hair">
      ...
      <div className="grid transition-all duration-300 ease-[cubic-bezier(.16,1,.3,1)]" style={{ gridTemplateRows: open ? '1fr' : '0fr' }}>
