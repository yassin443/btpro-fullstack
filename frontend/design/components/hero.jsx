            ...
            <div className="mt-3 flex h-[120px] items-end gap-1.5">
              {bars.map((b, i) => (
                <div key={i} className="flex flex-1 flex-col justify-end">
                  <div className="rounded-t-[3px] bg-gradient-to-t from-brand/30 to-brand"
                    style={{ height: `${b}%` }} />
                </div>
              ))}
            </div>
      ...
      <Container className="relative">
        ...
        <Reveal delay={340} className="relative mx-auto mt-14 max-w-[980px] pb-24">
          <div className="float-soft">
            <BorderBeam radius={18} duration={7} borderClass="ring-1 ring-hair shadow-glow"
...
Object.assign(window, { Hero, DashboardMock, BrowserFrame, BorderBeam });
