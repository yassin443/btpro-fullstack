/* ========================================================================
   ...
   Exposes: GoogleG, Field, PasswordField, strengthScore, StrengthMeter,
            AuthLayout, Divider, BulletList, Spinner, ErrorBanner
   ======================================================================== */
...
function GoogleButton({ onClick, loading, disabled, label = 'Continuer avec Google' }) {
  return (
...
function Field({ id, label, type = 'text', value, onChange, error, placeholder, autoComplete, rightSlot, onBlur, inputMode, leftSlot }) {
  return (
    <div>
...
function PasswordField({ id, label, value, onChange, error, placeholder = '••••••••', autoComplete = 'current-password', meter = false, onBlur }) {
...
function AuthLayout({ left, trust, children, maxW = 420 }) {
  const { go } = useNav();
  return (
...
Object.assign(window, {
  GoogleG, Spinner, Divider, ErrorBanner, GoogleButton,
  Field, PasswordField, strengthScore, StrengthMeter, BulletList, AuthLayout,
});
