/* ===================== Admin — shell (topbar + sidebar + router) ===================== */
const ADMIN_NAV = [
  ...
  { section: 'Finances', items: [
    { id: 'revenus', label: 'Revenus & Charges', icon: 'Wallet' },
  ] },
    ...
    <div className="flex h-screen flex-col bg-mist/40">
      ...
      <header className="z-20 flex h-14 shrink-0 items-center justify-between gap-3 border-b border-hair bg-white px-3 sm:px-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <span className="hidden font-mono text-[12px] text-muted lg:inline">yassint902@gmail.com</span>
          <span className="flex h-8 w-8 items-center justify-center rounded-full bg-brand font-mono text-[11px] font-bold text-white">YA</span>
          <button onClick={() => go('login')} className="flex h-9 items-center gap-1.5 rounded-lg px-2.5 text-[12.5px] font-semibold text-muted transition-colors hover:bg-mist hover:text-ink" title="Déconnexion">
